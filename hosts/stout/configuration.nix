{pkgs, ...}: {
  ...
  ########## VirtualBox ##########
  # The vboxdrv kernel module only exists if the host side is enabled here;
  # the `virtualbox` package alone (from a dev shell, say) gives you the GUI
  # and then fails with VERR_VM_DRIVER_NOT_INSTALLED.
